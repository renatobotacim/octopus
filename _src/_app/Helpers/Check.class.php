...
class Check {
    ...
    public static function Words($String, $Limite, $Pointer = null) {
        //limpa a string - tirando códigos html e espaços em branco
    ...
    public static function Image($ImageUrl, $ImageDesc, $ImageW = null, $ImageH = null) {
        ...
        //se o arquivo existe e se o arquivo não é um diretório
        if (file_exists(self::$Data) && !is_dir(self::$Data)):
            ...
            $patch = HOME;
            $noImg = 'uploads/semfoto2.jpg';
            return "<img src=\"{$patch}/tim.php?src={$patch}/{$noImg}&w={$ImageW}&h={$ImageH}\" alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\"/>";
        endif;
    }
