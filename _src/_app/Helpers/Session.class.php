...
/**
 * Session [ HELPER ]
 * Responsável pelas estatististicas, sessões e atualizaçãoes de tráfego do Sistema!
 * 
...
class Session {
    ...
    //verifica e executa todos os métidos da classe
    ...
    //obtem dados da tabela [helper de traffic]
    //ws_siteviews
    ...
    //verifica cria e atualiza Coohie do usuário [helper traffic]
    private function getCookie() {
        $Cookie = filter_input(INPUT_COOKIE, 'useronline', FILTER_DEFAULT);
        setcookie("useronline", base64_encode("infire"), time() + 86400);
        if (!$Cookie):
            return false;
        else:
            return true;
    ...
    //identifica o navegador do usuários
    ...
    // atualiza tabela com dados do navegador
