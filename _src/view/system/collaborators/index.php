...
$params = array('entries' => $entries, 'nome' => $nome);
          ...
          <div class="row">
            ...
            <div class="col-md-12 mt-2">
              <div class="form-group">
                <label>Nome</label>
                <input class="form-control form-control-sm" type="text" name="nome" id="numero"
...
//                                    endif;
                echo "<tr>"
                  ...
                  . "<td>"
                  . "<a class=\"btn btn-flat btn-sm btn-action btn-primary \" href=\"painel.php?exe={$navegacao[0]}/update&id={$colaborador_id}\" title=\"Alterar Registro\"><i class=\"fas fa-edit\"></i></a>"
                  . "<a class=\"btn btn-sm btn-flat btn-action btn-danger\" onclick=\"return confirm('Deseja realmente excluir esse registro?')\" type=\"submit\" title=\"Excluir Registro\" href=\"painel.php?exe={$navegacao[0]}/index&delete={$colaborador_id}\"><i class=\"fas fa-trash-alt\"></i></a>"
                  . "</tr>";
              endforeach;
            else:
