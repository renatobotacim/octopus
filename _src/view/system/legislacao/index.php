    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-header"><h3 class="card-title">
                    <i class="fas fa-list"></i>&nbsp;&nbsp;Listagem de Legislações Infralegais</h3>
            </div>
            <div class="">
                        ...
                        <tbody id="tabela-titulo">
                            ...
                            if (!empty($Data)):
                                foreach ($Data as $i):
                                    ...
                                    echo "<tr>"
                                    . "<td>{$infralegal_id}</td>"
                                    . "<td>{$infralegal_ano}-{$infralegal_numero}</td>"
                                    . "<td>{$infralegal_assunto}</td>"
                                    . "<td>{$infralegal_tipo_nome}<br>{$legislacao_sistema_nome}</td>"
                                    . "<td><a class=\"btn btn-sm btn-sm btn-flat btn-info\" href=\"{$infralegal_link}\" target=\"_blank\"><i class=\"fas fa-eye\"></i></a></td>"
                                    . "<td><a class=\"btn btn-flat btn-sm btn-action btn-primary \" href=\"painel.php?exe={$navegacao[0]}/update&id={$infralegal_id}\" title=\"Alterar Registro\"><i class=\"fas fa-edit\"></i></a>"
                                    . "<a class=\"btn btn-sm btn-flat btn-action btn-danger\" onclick=\"return confirm('Deseja realmente excluir esse registro?')\" type=\"submit\" title=\"Excluir Registro\" href=\"painel.php?exe={$navegacao[0]}/index&delete={$infralegal_id}\"><i class=\"fas fa-trash-alt\"></i></a>"
                                    . "</tr>";
                                endforeach;
                            else:
