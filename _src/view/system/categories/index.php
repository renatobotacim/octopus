...
$name = filter_input(INPUT_GET, 'titulo', FILTER_DEFAULT);
...
$params = array('entries' => $entries, 'titulo' => $name, 'pai' => $pai);
  ...
  <div class="container-fluid">
    ...
    <div class="card card-primary card-outline">
      ...
      <div class="card-header"><h3 class="card-title">
          <i class="fas fa-list"></i>&nbsp;&nbspLista de Categorias</h3>
      </div>
        ...
        <div class="card-body">
          <table id="datatable" class="table table-bordered table-striped">
            ...
            if (!empty($Data)):
              foreach ($Data as $i):
                extract($i);
                if ($categoria_status == 1) {
                  $categoria_status = "Inativo";
                } else {
                  $categoria_status = "Ativo";
                }
                echo "<tr>"
                  . "<td>{$categoria_id}</td>"
                  . "<td>{$categoria_nome}</td>"
                  . "<td>{$categoria_status}</td>"
