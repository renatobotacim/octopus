 ...
 */
    ...
    const Entity = "inf_colaboradores";
    const ColumnID = "colaborador_id";
    ...
    private function Create() {
        ...
        if ($create->getResult()):
            ...
            $this->Result = false;
            $this->Error = ["<b>OPSSSS!</b><br>Desculpe, mas ocorreu algum erro ao realziar o cadastro, tente novamente!", IMD_ALERT];
        endif;
    }
